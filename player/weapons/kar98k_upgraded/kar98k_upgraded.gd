...
func _init():
	...
	texture = load("res://assets/sprites/guns/kar98k_puck_a_panch.png") # The path of the sprite gun.

	bulletpoint = Vector2(68.153, -6.719) # Position of the bulletpoint.
	bulletdelay = float(1.25) # The delay between each bullet. [0.1, 0.2]

	_bullet = Bullet.new(float(1300), float(1700), "res://assets/scenes/bullet.tscn", int(5)) 
