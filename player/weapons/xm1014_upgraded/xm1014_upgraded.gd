...
func _init():
	...
	texture = load("res://player/weapons/xm1014_upgraded/xm1014_upgraded.png") # The path of the sprite gun.

	bulletpoint = Vector2(60.699,-4.934) # Position of the bulletpoint.
	bulletdelay = float(0.4) # The delay between each bullet. [0.1, 0.2]

	_bullet = Bullet.new(float(1800), float(850), "res://player/weapons/all_bullet_scenes/laser_purple/bullet_laser_purple.tscn", int(2)) 
