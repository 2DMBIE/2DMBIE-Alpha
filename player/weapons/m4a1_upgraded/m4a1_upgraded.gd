...
func _init():
	name = "M4A1pap" # The name of the gun.
	...
	texture = load("res://player/weapons/m4a1_upgraded/m4a1_upgraded.png") # The path of the sprite gun.

	bulletpoint = Vector2(69.339,-8.287) # Position of the bulletpoint.
	bulletdelay = float(.15) # The delay between each bullet. [0.1, 0.2]

	_bullet = Bullet.new(float(320), float(1250), "res://player/weapons/all_bullet_scenes/normal_bullet/bullet.tscn" , int(5)) 
